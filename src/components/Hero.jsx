...
function Hero() {
  return (
    <motion.div 
      ...
      id='home'
      className='min-h-screen flex items-center pt-24 lg:pt-28 pb-12 lg:pb-16 bg-gradient-to-b from-[#121212] via-[#1a1824] to-[#121212] relative overflow-hidden'
    >
      ...
      <div className='container mx-auto px-6 md:px-12 max-w-7xl relative z-10 flex flex-col-reverse lg:flex-row items-center justify-between gap-8 lg:gap-12'>
        ...
        >
          <div className='inline-block mb-4 px-4 py-1.5 rounded-full bg-purple-500/10 border border-purple-500/30 backdrop-blur-md'>
            <span className='text-purple-300 font-medium text-sm md:text-base tracking-wide'>
              🚀 Welcome to my portfolio
            </span>
          </div>

          <h1 className='text-4xl sm:text-5xl md:text-6xl lg:text-[3.5rem] xl:text-[4rem] text-white font-extrabold tracking-tight mb-4 leading-tight'>
            Hi, I'm{' '}
          ...
          <div className='h-10 md:h-12 flex items-center justify-center lg:justify-start mb-5'>
            <h2 className='text-2xl sm:text-3xl md:text-4xl font-bold text-gray-100 typewriter'>
              Full Stack Developer
            </h2>
          </div>

          <p className='text-base sm:text-lg md:text-xl text-gray-300 mb-8 max-w-xl leading-relaxed mx-auto lg:mx-0 font-normal'>
          ...
          <div className='flex flex-wrap items-center justify-center lg:justify-start gap-4'>
            <a 
              href='#projects' 
              className='inline-flex items-center gap-3 bg-gradient-to-r from-purple-600 via-purple-700 to-pink-600 text-white text-base md:text-lg font-semibold px-7 py-3.5 rounded-xl shadow-lg shadow-purple-600/30 hover:shadow-purple-500/50 hover:scale-[1.03] active:scale-95 transition-all duration-300 group'
            >
              <span>View Work</span>
            ...
            <a 
              href='#contact' 
              className='inline-flex items-center gap-3 border-2 border-purple-500/80 text-white text-base md:text-lg font-semibold px-7 py-3.5 rounded-xl backdrop-blur-sm hover:bg-purple-500/20 hover:border-pink-400 hover:scale-[1.03] active:scale-95 transition-all duration-300 shadow-md'
            >
        ...
        >
          <div className='relative w-64 h-64 sm:w-80 sm:h-80 md:w-[340px] md:h-[340px] lg:w-[380px] lg:h-[380px] xl:w-[410px] xl:h-[410px] flex justify-center items-center shrink-0'>
